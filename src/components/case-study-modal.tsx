...
export function CaseStudyModal({
  ...
  return (
    <Dialog.Root open onOpenChange={(o) => !o && closeModal()}>
      <Dialog.Portal>
        {/* Backdrop - completely separate layer, uses motion for reliable fade */}
        <motion.div
              ...
              <BlurFade delay={BLUR_FADE_DELAY} className="overflow-hidden">
                <div className="p-6 max-w-2xl mx-auto">
                  <Link
                    ...
                    className="text-sm text-muted-foreground hover:text-foreground transition-colors border border-border rounded-lg px-2 py-1 inline-flex items-center gap-1 mb-6 group w-fit"
                    aria-label="Close"
                  >
