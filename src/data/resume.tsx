...
export const DATA = {
  name: "Aly Abou-Zaid",
  initials: "AA",
  url: "https://alyaabouzaid.com",
  location: "St. Louis, MO",
  locationLink: "https://www.google.com/maps/place/stlouis",
  description:
    "Engineer, designer, and builder. I love creating things and bringing ideas to life.",
  summary:
  ...
  contact: {
    ...
    social: {
      ...
      email: {
        name: "Send Email",
        url: "mailto:3liabouzaid@gmail.com",
        icon: Icons.email,
        navbar: false,
      },
    },
